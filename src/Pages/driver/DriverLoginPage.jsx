  ...
  return (
    <div className="min-h-screen w-full flex flex-col relative bg-[#0f172a] overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-full h-full">
        <div className="absolute top-1/4 -left-1/4 w-1/2 h-1/2 bg-yellow-500/20 rounded-full blur-[100px]"></div>
        <div className="absolute bottom-1/4 -right-1/4 w-1/2 h-1/2 bg-yellow-500/10 rounded-full blur-[100px]"></div>
      </div>
        ...
        <div className="w-full max-w-md">
          ...
          <div className="backdrop-blur-xl bg-white/10 rounded-2xl shadow-2xl border border-white/20 p-8">
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                disabled={isLoading}
                className="w-full bg-gradient-to-r from-yellow-500 to-yellow-600 text-white font-medium py-3 px-4 
                         rounded-lg hover:from-yellow-600 hover:to-yellow-700 focus:outline-none focus:ring-2 
                         focus:ring-yellow-500 focus:ring-offset-2 focus:ring-offset-[#0f172a] transition-all
          ...
          <div className="mt-8 text-center space-y-2">
            <p className="text-gray-400 text-sm">
              ...
              <Lock className="w-4 h-4 inline-block text-yellow-400" />
            </p>
